    ...
    <section class="row">
        <article class="offset-1 col-10 bg-light">
            ...
            <p class="text-center">
                ...
                echo "Сумма элементов строк, которые содержать хотя бы один отрицательный: ",
                "<span class='badge badge-success'>", sprintf("%01.2f", sumElemsRowsNeg($matrix));
                echo "</span><br/><br/><h5 class='text-center'>Номера строк и столбцов всех седловых точек:</h5>";
                saddlePointsRowsColumns($matrix);
                echo "</p>"
                ?>
            </p>
        </article>
